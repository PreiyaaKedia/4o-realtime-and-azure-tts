...
class Client:
    ...
    @classmethod
    async def text_to_speech_realtime(self, speech_synthesizer : speechsdk.SpeechSynthesizer, text: str, voice: str, speed: str = "medium"):
        ...
        speech_synthesizer1 = speechsdk.SpeechSynthesizer(speech_config=speech_config, audio_config=audio_output_config)
        # Synthesize speech
